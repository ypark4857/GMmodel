...
class MarketMakerOriginal : public MarketMakerBase {
public:
	// Constructor for MarketMaker class
	MarketMakerOriginal(double v_h, double v_l, double pi);
...
class TraderOriginal : public TraderBase {
public:
	// Constructor for Trader class
	TraderOriginal(double pi, std::default_random_engine* const gen_ptr);
